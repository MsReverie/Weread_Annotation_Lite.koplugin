...
@module WereadAnnotationLite.ui.thought_popup
--]]

local FaceFactory = require("WereadAnnotationLite.ui.thought_popup_text").FaceFactory
...
local function widgetClassFor()
    return require("WereadAnnotationLite.ui.thought_popup_widget")
end
