...
Normalized review items (WereadAnnotationLite.lib.annotations records: abstract, author,
    ...
    for _, item in ipairs(items) do
        ...
        if content ~= "" then
            blocks[#blocks + 1] = {
                ...
                variant = "content",
                text = content,
                -- Thought text should match the book text rather than the
                -- lighter annotation metadata. With the popup's default
                -- contrast this resolves to pure black.
                fg = require("ffi/blitbuffer").COLOR_BLACK,
            }
        end
    end
