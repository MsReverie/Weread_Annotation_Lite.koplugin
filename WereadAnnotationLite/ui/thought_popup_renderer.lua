...
local TextParts = require("WereadAnnotationLite.ui.thought_popup_text")
local ContentBuilder = TextParts.ContentBuilder
local FaceFactory = TextParts.FaceFactory
...
function PageRenderer:paginate()
    ...
    local function addSpacing(height)
        ...
        local top = y
        y = y + height
        boundaries[#boundaries + 1] = { top = top, bottom = y }
    end
...
PageRenderer.Paginator = Paginator
return PageRenderer
